...
def policz_kat_dwuscienny(a,b,c,d):
    ...
    try:
        ...
        orto3 = cross(orto2,orto1)  #produkt mnozenia wektorowego powyzszego daje brakujacy wektor ortogonalny
        
        #5# Oblicz wartosc sinusa i cosinusa szukanego kata
        cosinus = dot(normalna_abc,orto1) #mnozenie skalarne normalnych 1. i 2. plaszczyzny (orto1 = normalna_bcd, patrz pkt 4.)
        sinus = dot(normalna_abc,orto3)   #mnozenie skalarne normalnej 1. plaszczyzny i obliczonego w pkt 4. wektora ortogonalnego
